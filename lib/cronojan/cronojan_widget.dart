...
import 'cronojan_model.dart';
export 'cronojan_model.dart';

class CronojanWidget extends StatefulWidget {
  const CronojanWidget({super.key});

  static String routeName = 'cronojan';
  static String routePath = '/cronojan';

  @override
  State<CronojanWidget> createState() => _CronojanWidgetState();
}

class _CronojanWidgetState extends State<CronojanWidget> {
  late CronojanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CronojanModel());
